...
- Brightness tone-down was kept to existing scene constants: modestly lower HDR/environment intensity, key/fill/hemi lights, exposure, and fog density with the same bounded shadow settings and `hdr.hdr`.
